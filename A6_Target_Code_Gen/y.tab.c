...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    LE = 267,                      /* LE  */
    GE = 268,                      /* GE  */
    INVALID_TOKEN = 269,           /* INVALID_TOKEN  */
    PLUS = 270,                    /* PLUS  */
    MINUS = 271,                   /* MINUS  */
    MULT = 272,                    /* MULT  */
    DIV = 273,                     /* DIV  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_oper = 34,                      /* oper  */
  YYSYMBOL_reln = 35                       /* reln  */
};
...
static const yytype_uint8 yyrline[] =
{
     ...
     105,   109,   113,   117,   121,   125,   126,   127,   131,   132,
...
static const char *const yytname[] =
{
  ...
  "list", "stmt", "asgn", "cond", "loop", "M", "N", "expr", "bool", "atom",
...
{
       6,    22,    11,   -27,     6,   -27,   -27,   -27,    -7,    13,
      13,   -27,   -27,    -2,    -5,   -27,   -27,     5,   -27,   -27,
     -27,    10,   -27,   -27,   -27,   -27,   -27,   -27,    -2,     6,
       6,   -27,   -27,   -27,   -27,   -27,    -2,   -27,    -2,    26,
     -27,    -2,    27,   -27,    28,    29,   -27,   -27,   -27
};
...
{
       0,     0,     0,     2,     3,     5,     6,     7,     0,     0,
       0,     1,     4,     0,     0,    11,    11,     0,    15,    16,
      17,     0,    23,    24,    25,    26,    27,    28,     0,     0,
       0,    18,    19,    20,    21,    22,     0,     8,     0,     0,
      12,     0,     0,     9,     0,     0,    14,    10,    13
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -27,   -27,    -4,   -27,   -27,   -27,   -27,     1,   -27,   -27,
      24,   -26,   -27,   -27
};
...
{
      12,    17,    38,    22,    23,    24,    25,    26,    27,     1,
      41,    11,    42,    13,    37,    45,    14,    30,    18,    19,
      31,    32,    33,    34,    35,    39,    40,     8,     9,    10,
      43,    46,    47,    48,    16
};

static const yytype_int8 yycheck[] =
{
       4,     3,    28,     8,     9,    10,    11,    12,    13,     3,
      36,     0,    38,    20,     4,    41,     3,    16,    20,    21,
      15,    16,    17,    18,    19,    29,    30,     5,     6,     7,
       4,     4,     4,     4,    10
};
...
static const yytype_int8 yystos[] =
{
       ...
       7,     0,    24,    20,     3,    32,    32,     3,    20,    21,
      31,    33,     8,     9,    10,    11,    12,    13,    35,    29,
      29,    15,    16,    17,    18,    19,    34,     4,    33,    24,
      24,    33,    33,     4,    30,    33,     4,     4,     4
};
...
#line 93 "prog.y"
          { 
		setID((yyvsp[-2].text), (yyvsp[-1].text)); 
...
#line 100 "prog.y"
                                                { backpatch((yyvsp[-2].num)+2, instruction_count+1); }
#line 1307 "y.tab.c"
    break;

  case 10: /* loop: LP LOOP bool M list N RP  */
#line 105 "prog.y"
                                                { backpatch((yyvsp[-3].num)+1, instruction_count+1); backpatch((yyvsp[-1].num)+2, (yyvsp[-3].num)); }
#line 1313 "y.tab.c"
    break;
...
#line 1325 "y.tab.c"
  ...
  case 13: /* expr: LP oper atom atom RP  */
#line 117 "prog.y"
                                        { (yyval.text) = generateTemp(); char s[1] = {(char)(yyvsp[-3].num)}; emit(s, (yyvsp[-2].text), (yyvsp[-1].text), (yyval.text)); }
#line 1331 "y.tab.c"
    break;

  case 14: /* bool: LP reln atom atom RP  */
#line 121 "prog.y"
